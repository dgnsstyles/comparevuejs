      ...
      <div class="columns pd">
        <div class="column">
          <div class="card">
            ...
            <p class="subtitle">- David Goren</p>
            </div>
          </div>
        </div>
        <div class="column">
...
export default {
  ...
  data() {
    return {
      heading: 'Soaring new heights',
      subheading: 'Pinterest leggings pickled unicorn. Bitters shaman snackwave fashion axe helvetica gluten-free'
    }
  }
}
</script>
